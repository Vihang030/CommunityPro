...
namespace CommunityPro.Controllers
{
    public class QualificationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,DegreeName")] Qualification qualification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,DegreeName")] Qualification qualification)
        {
            if (ModelState.IsValid)
            {
